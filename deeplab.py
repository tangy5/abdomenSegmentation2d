...
class ASPP(nn.Module):
    ...
    def __init__(self, C, depth, num_classes, conv=nn.Conv2d, norm=nn.BatchNorm2d,
...
def resnet101(pretrained=False, num_groups=None, weight_std=False, **kwModuleargs):
    """Constructs a ResNet-101 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_groups=num_groups, weight_std=weight_std, **kwModuleargs)
    if pretrained:
